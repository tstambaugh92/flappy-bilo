...
The source-code license in the repository root does not apply to files in
this directory.

Unless a separate license is included with a particular asset, all artwork,
audio, fonts, and other media assets are all rights reserved by their
